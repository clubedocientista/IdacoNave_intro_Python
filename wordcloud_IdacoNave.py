...
def main ():
    ...
    pasta   = 'D:\\Documentos\\Clube do Cientista\\cursos\\Python_IdacoNave\\'
    arquivo = 'IdacoNave + Clube do Cientista (respostas).xlsx'
